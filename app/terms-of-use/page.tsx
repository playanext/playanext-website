      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-16 sm:py-20">
        ...
        <div className="bg-slate-900/50 backdrop-blur-xl border border-slate-800 rounded-2xl p-6 sm:p-10">
          ...
          <div className="space-y-6 text-slate-300 leading-relaxed">
            <p>Agreement between User and PlayaNext LLC</p>
            <p>
              Welcome to www.playanext.com. The www.playanext.com website (the
              "Site") is comprised of various web pages operated by PlayaNext
              LLC ("PlayaNext", "we," or "us"). The Site is offered to you
              ...
              of www.playanext.com constitutes your agreement to all such Terms.
              Please read these terms carefully, and keep a copy of them for
              your reference.
            </p>
            <p>
              The purpose of the Site is to provide information regarding the
              business of PlayaNext and its subsidiaries.
            </p>
            ...
            <p>
              Your use of www.playanext.com is subject to PlayaNext's Privacy
            ...
            <p>
              Visiting www.playanext.com or sending emails to PlayaNext
            ...
            <p>
              PlayaNext does not knowingly collect, either online or offline,
              personal information from persons under the age of thirteen. If
              you are under 18, you may use www.playanext.com only with
            ...
            <p>
              ...
              Linked Sites are not under the control of PlayaNext and PlayaNext
              ...
              changes or updates to a Linked Site. PlayaNext is providing these
              links to you only as a convenience, and the inclusion of any link
              does not imply endorsement by PlayaNext of the site or any
              association with its operators.
            </p>
            <p>
              Certain services made available via www.playanext.com are
              delivered by third party sites and organizations. By using any
              product, service or functionality originating from the
              www.playanext.com domain, you hereby acknowledge and consent that
              PlayaNext may share such information and data with any third party
              with whom PlayaNext has a contractual relationship to provide the
              requested product, service or functionality on behalf of
              www.playanext.com users and customers.
            </p>
            ...
            <p>
              ...
              license to access and use www.playanext.com strictly in accordance
              with these terms of use. As a condition of your use of the Site,
              you warrant to PlayaNext that you will not use the Site for any
            ...
            <p>
              ...
              any software used on the Site, is the property of PlayaNext or its
            ...
            <p>
              ...
              on the Site. PlayaNext content is not for resale. Your use of the
              ...
              permission of PlayaNext and the copyright owner. You agree that
              ...
              intellectual property of PlayaNext or our licensors except as
            ...
            <p>
              The Service is controlled, operated and administered by PlayaNext
              ...
              all local laws. You agree that you will not use the PlayaNext
              Content accessed through www.playanext.com in any country or in
            ...
            <p>
              You agree to indemnify, defend and hold harmless PlayaNext, its
              ...
              applicable laws, rules or regulations. PlayaNext reserves the
              ...
              in which event you will fully cooperate with PlayaNext in
            ...
            <p>
              ...
              ACTION AGAINST THE OTHER. Further, unless both you and PlayaNext
            ...
            <p className="uppercase">
              ...
              INFORMATION HEREIN. PLAYANEXT AND/OR ITS SUPPLIERS MAY MAKE
              IMPROVEMENTS AND/OR CHANGES IN THE SITE AT ANY TIME.
            </p>
            <p className="uppercase">
              PLAYANEXT LLC AND/OR ITS SUPPLIERS MAKE NO REPRESENTATIONS ABOUT
              ...
              IS" WITHOUT WARRANTY OR CONDITION OF ANY KIND. PLAYANEXT LLC
            ...
            <p className="uppercase">
              ...
              SHALL PLAYANEXT LLC AND/OR ITS SUPPLIERS BE LIABLE FOR ANY DIRECT,
              ...
              PLAYANEXT LLC OR ANY OF ITS SUPPLIERS HAS BEEN ADVISED OF THE
            ...
            <p>
              PlayaNext reserves the right, in its sole discretion, to terminate
            ...
            <p>
              ...
              agency relationship exists between you and PlayaNext as a result
              of this agreement or use of the Site. PlayaNext's performance of
              this agreement is subject to existing laws and legal process, and
              nothing contained in this agreement is in derogation of
              PlayaNext's right to comply with governmental, court and law
              enforcement requests or requirements relating to your use of the
              Site or information provided to or gathered by PlayaNext with
            ...
            <p>
              ...
              entire agreement between the user and PlayaNext with respect to
              the Site and it supersedes all prior or contemporaneous
              communications and proposals, whether electronic, oral or written,
              between the user and PlayaNext with respect to the Site. A printed
            ...
            <p>
              PlayaNext reserves the right, in its sole discretion, to change
              the Terms under which www.playanext.com is offered. The most
              current version of the Terms will supersede all previous versions.
              PlayaNext encourages you to periodically review the Terms to stay
            ...
            <p>
              PlayaNext welcomes your questions or comments regarding the Terms:
            </p>

            <div className="mt-4">
              <p>PlayaNext LLC</p>
              <p>3019 Wilshire Blvd, #309</p>
              <p>Santa Monica, California 90403</p>
            </div>
            ...
            <p className="mt-8 font-medium">Effective as of March 01, 2023</p>
          </div>
        </div>
      </div>
    </div>
